...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20230312100018_mig_destination_guide_relation")]
    partial class migdestinationguiderelation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EntityLayer.Concrete.Comment", b =>
                {
                    ...
                    b.HasOne("EntityLayer.Concrete.Desnination", "Desnination")
                        .WithMany("Comments")
                        .HasForeignKey("DesninationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AppUser");

                    b.Navigation("Desnination");
                });

            modelBuilder.Entity("EntityLayer.Concrete.Desnination", b =>
                {
                    b.HasOne("EntityLayer.Concrete.Guide", "Guide")
                        .WithMany("Desninations")
